 ...
 */
final class Version20220313125651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Company (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, cnpj VARCHAR(255) NOT NULL, logo_comapany VARCHAR(255) NOT NULL, INDEX IDX_800230D3A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE User (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, pass VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE Company ADD CONSTRAINT FK_800230D3A76ED395 FOREIGN KEY (user_id) REFERENCES User (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Company DROP FOREIGN KEY FK_800230D3A76ED395');
        $this->addSql('ALTER TABLE Expenses DROP FOREIGN KEY FK_DDE0910DA76ED395');
        $this->addSql('ALTER TABLE Gain DROP FOREIGN KEY FK_70A7823EA76ED395');
